...
router.delete('/deletetrip/:id', validateSession, (req,res) => {
    trip.destroy({ where: { id:req.params.id, owner : req.user.id }})
    .then(
...
//Admin Trip Delete//
router.delete('/admindeltrip/:id', validateSession, (req,res) => {
